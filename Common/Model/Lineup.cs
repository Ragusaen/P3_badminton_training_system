    ...
    public class Lineup
    {
        ...
        public static Dictionary<TeamMatch.Leagues, Dictionary<PositionType, int>> LeaguePositions =
            new Dictionary<TeamMatch.Leagues, Dictionary<PositionType, int>>()
            {
                ...
                { TeamMatch.Leagues.RegionalSeries, new Dictionary<PositionType, int>() {{PositionType.MensDouble, 3}, {PositionType.MensSingle, 4}, {PositionType.WomensSingle, 2}, {PositionType.WomensDouble, 2}, {PositionType.MixDouble, 2}} },
                { TeamMatch.Leagues.Series1, new Dictionary<PositionType, int>() {{PositionType.MensDouble, 2}, {PositionType.MensSingle, 4}, {PositionType.WomensSingle, 2}, {PositionType.WomensDouble, 1}, {PositionType.MixDouble, 2}} },
                { TeamMatch.Leagues.Series2, new Dictionary<PositionType, int>() {{PositionType.MensDouble, 2}, {PositionType.MensSingle, 3}, {PositionType.WomensSingle, 1}, {PositionType.WomensDouble, 1}, {PositionType.MixDouble, 1}} },
            };
    }
}