...
namespace Test
{
    ...
    public class ParserUpdatesLevelPointsForFirstPlayerOnRankings
    {
        ...
        public void Test()
        {
            ...
            p[0].BadmintonId = 96021601; p[0].Rankings = new PlayerRanking(); p[0].Rankings.LevelPoints = 50;
    ...
    public class ParserUpdatesLevelPointsForSecondPlayerOnRankings
    {
        ...
        public void Test()
        {
            ...
            p[0].BadmintonId = 96021601; p[0].Rankings = new PlayerRanking(); p[0].Rankings.LevelPoints = 50;
            p[1].BadmintonId = 97022603; p[1].Rankings = new PlayerRanking(); p[1].Rankings.LevelPoints = 50;
